...
CREATE TABLE `signs_detail` (
  ...
  `key_id` varchar(128) COLLATE utf8mb4_bin COMMENT 'mpc sign key ID',
  ...
  `rsv` mediumtext COLLATE utf8mb4_bin NOT NULL COMMENT 'rsv list separated by |',
  ...
  `reply_initializer` tinyint(2) NOT NULL COMMENT '0:not initializer ,1: initializer',
  `reply_status` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT 'reply status of creating mpc wallet',
  `reply_timestamp` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT 'reply timestamp',
  `reply_enode` varchar(512) COLLATE utf8mb4_bin NOT NULL COMMENT 'reply enode',
  `initiator_public_key` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT 'initial public key',
