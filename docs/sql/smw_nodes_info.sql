...
CREATE TABLE `nodes_info` (
  ...
  `ip_addr` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '节点IP',
  `name` varchar(256) COLLATE utf8mb4_bin NOT NULL COMMENT '节点名字',
  `email` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '节点email地址',
  `telegram_id` varchar(256) COLLATE utf8mb4_bin NOT NULL COMMENT '节点telegram的id',
